...
<nav class="navbar navbar-inverse navbar-fixed-top">
 ...
 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
    	...
    	<li  class="active"><a href="anwesenheit.php">Presence<span class="sr-only">(current)</span></a></li>
        <!--<li><a href="abwesend.php">Abwesend</a></li>
...
<table><tr>
<td style="font-size:100%;color:#ffffff;" align="left" bgcolor="#000000">
<b>&ensp;present</b>
</td>
<td style="font-size:100%;color:#ffffff;" align="right" bgcolor="#000000">
<b>not present&ensp;</b>
</td>
</tr><tr>
<td valign="top">
...
<?php
	...
	foreach ($users as $user) {
		if ($user[9] == 0) {
			$out_of_office_part = '<td align="center"><form name="user_'.$user[0].'_anw" action="anwesenheit.php" method="post">
			...
			<button type="submit" class="btn btn-xs btn-danger"><b>set to "not present"</b></button>
			</form></td>';
...
';
	...
	foreach ($users as $user) {
		if ($user[9] == 1) {
			$out_of_office_part = '<td align="center"><form name="user_'.$user[0].'_abw" action="anwesenheit.php" method="post">
			<input type="hidden" name="action" value="out_of_office">
			<input type="hidden" name="user" value="'.$user[0].'">
			<input type="hidden" name="out_of_office" value="'.$user[9].'">
			<button type="submit" class="btn btn-xs btn-success"><b>set to "present"</b></button>
			</form></td>';
			$name_part = '<td align="right"><b>'.$job.' '.$user[6].' '.$user[7].'</b></td>';
			echo '<tr'.$_tr.'>';
			echo $out_of_office_part;
