...
<nav class="navbar navbar-inverse navbar-fixed-top">
 ...
 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
    	...
    	<li  class="active"><a href="anwesend.php">Anwesend<span class="sr-only">(current)</span></a></li>
...
<?php
	...
	foreach ($users as $user) {
		if ($user[9] == 0) {
			$out_of_office_part = '<td align="center"><form name="user_'.$user[0].'" action="anwesend.php" method="post">
			...
			<button type="submit" class="btn btn-xs btn-danger"><b>auf "abwesend" setzen</b></button>
			</form></td>';
